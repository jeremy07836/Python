...
if __name__ == "__main__":
    ...
    print(timeit.timeit(upper_comp, number=100000))
    print(timeit.timeit(upper_map, number=100000))
    print(timeit.timeit(split_comp, number=100000))
    print(timeit.timeit(split_map, number=100000))
